                ...
                <tr>
                  ...
                  <td style="width: 50px; text-align: center; padding-top: 5px;">
                    <form method="POST" action="<?= base_url('elevadores/estatus_change_elevadores') ?>">
                      ...
                      <button style="cursor: pointer; background-color: #00a6f5; color: #fff;" type="submit" name="completar_elevador" class="btn btn-sm btn-info"><i class="fa fa-check"></i></button>
                    </form>
                  </td>
                </tr>
            <?php }
