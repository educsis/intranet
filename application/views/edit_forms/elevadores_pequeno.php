<form class="pequenaForm formE" method="POST" action="<?= base_url('elevadores/editar_elevador/' . $idsol . '/' . $tiposol) ?>">
	<div class="form">
		...
		<div class="col-md-3 form-group">
			...
			<option value="" selected="selected" disabled="disabled" required="required">Selecciona una opción</option>
				<option value="Ingreso" <?= ($elevador_info[0]['requerimiento'] == 'Ingreso')?'selected = "selected"':'' ?>>Ingreso</option>
				<option value="Retiro" <?= ($elevador_info[0]['requerimiento'] == 'Retiro')?'selected = "selected"':'' ?>>Retiro</option>
				<option value="Traslado dentro de Zona Pradera" <?= ($elevador_info[0]['requerimiento'] == 'Traslado dentro de Zona Pradera')?'selected = "selected"':'' ?>>Traslado dentro de Zona Pradera</option>
			</select>
		</div>
		</div>
		<div class="row">
		...
		<button type="submit" style="cursor: pointer;" name="editarElevadoresPequena" class="btn btn-info mg-r-5">Editar solicitud</button>
