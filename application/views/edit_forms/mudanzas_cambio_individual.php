<form method="POST" class="cambioIndividual formE" action="<?= base_url('mudanzas/editar_mudanzas/' . $idsol . '/' . $tiposol) ?>" enctype="multipart/form-data">
	<div class="form">
		...
		<div class="form-layout-footer">
			<button type="submit" style="cursor: pointer;" name="editar_cambio_individual" class="btn btn-info mg-r-5">Editar solicitud</button>
