<form method="POST" class="ingresoSA formE" action="<?= base_url('mudanzas/editar_mudanzas/' . $idsol . '/' . $tiposol) ?>" enctype="multipart/form-data">
	<div class="form">
		...
		<div class="col-md-12">
			...
			<tbody>
				...
				<tr>
					<td style="width: 30px; text-align: center;"><a href="<?= base_url('mudanzas-docs/' . $files[0]['file5']) ?>" target="_blank"><img src="<?= base_url('assets/svgicons/link.svg') ?>" class="menuicon"></a></td>
				...
				<tr>
					<td style="width: 30px; text-align: center;"><a href="<?= base_url('mudanzas-docs/' . $files[0]['file9']) ?>" target="_blank"><img src="<?= base_url('assets/svgicons/link.svg') ?>" class="menuicon"></a></td>
					<td>Logo de la empresa en formato .jpg</td>
					<td><input type="FILE" name="file9" class="form-control"></td>
				</tr>
				<tr>
					<td style="width: 30px; text-align: center;"><a href="<?= base_url('mudanzas-docs/' . $files[0]['file10']) ?>" target="_blank"><img src="<?= base_url('assets/svgicons/link.svg') ?>" class="menuicon"></a></td>
					<td>Copia de póliza de Responsabilidad Civil. *</td>
					<td><input type="FILE" name="file10" class="form-control"></td>
				</tr>
				<tr>
					<td style="width: 30px; text-align: center;"><a href="<?= base_url('mudanzas-docs/' . $files[0]['file11']) ?>" target="_blank"><img src="<?= base_url('assets/svgicons/link.svg') ?>" class="menuicon"></a></td>
		...
		<div class="form-layout-footer">
			<button type="submit" style="cursor: pointer;" name="editar_ingreso_sociedad_anonima" class="btn btn-info mg-r-5">Editar solicitud</button>
