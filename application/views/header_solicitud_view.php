...
<body>
	...
	<div class="am-header">
		<div class="am-header-left">
			...
			<a href="<?= base_url() ?>" class="am-logo"><img src="<?= base_url('assets/img/logo.png') ?>" style="width: 150px;"></a>
		</div><!-- am-header-left -->

	</div><!-- am-header -->

	<div class="container" style="margin-top: 60px; background-color: #2D3A50; padding-bottom: 30px;">
		<h2 class="am-title" style="padding-top: 10px; color: #fff; text-align: center;"><?= strtoupper($title); ?></h2>